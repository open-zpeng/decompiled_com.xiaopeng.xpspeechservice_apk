...
public class ThreadUtils {
    ...
    public static void execute(final Runnable runnable, final Runnable callback, final int priority) {
        try {
            if (!sThreadPool.isShutdown()) {
                ...
                sThreadPool.execute(new Runnable() { // from class: com.xiaopeng.xpspeechservice.utils.ThreadUtils.1
    ...
    private static void doPost(int threadType, final Runnable preCallback, final Runnable task, final Runnable postCallback, final boolean callbackToMainThread, long delayMillis) {
        ...
        final Runnable postRunnable = new Runnable() { // from class: com.xiaopeng.xpspeechservice.utils.ThreadUtils.2
            @Override // java.lang.Runnable
            public void run() {
                try {
                    task.run();
        ...
        Runnable realRunnable = new Runnable() { // from class: com.xiaopeng.xpspeechservice.utils.ThreadUtils.3
            @Override // java.lang.Runnable
            public void run() {
                if (preCallback != null) {
                    if (callbackToMainThread || looper == ThreadUtils.sMainThreadHandler.getLooper()) {
                        ThreadUtils.sMainThreadHandler.post(new Runnable() { // from class: com.xiaopeng.xpspeechservice.utils.ThreadUtils.3.1
                            @Override // java.lang.Runnable
                            public void run() {
                                preCallback.run();
                        ...
                        new Handler(looper).post(new Runnable() { // from class: com.xiaopeng.xpspeechservice.utils.ThreadUtils.3.2
                            @Override // java.lang.Runnable
                            public void run() {
                                preCallback.run();
                                finalHandler.post(postRunnable);
    ...
    private static class ThreadFactoryBuilder {
        ...
        ThreadFactory build() {
            return new ThreadFactory() { // from class: com.xiaopeng.xpspeechservice.utils.ThreadUtils.ThreadFactoryBuilder.1
